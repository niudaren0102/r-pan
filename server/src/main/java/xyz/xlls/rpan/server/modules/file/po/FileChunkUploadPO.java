...
public class FileChunkUploadPO implements Serializable {
    ...
    private static final long serialVersionUID = -3396913915824744561L;
    ...
    @NotNull(message = "当前的分片下表不能为空")
    private Integer chunkNumber;
    @ApiModelProperty(value = "当前分片的大小",required = true)
    @NotNull(message = "当前分片的大小不能为空")
    private Long currentChunkSize;
    @ApiModelProperty(value = "总体大小",required = true)
    @NotNull(message = "总体大小不能为空")
